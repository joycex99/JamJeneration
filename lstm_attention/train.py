...
input_data, target_data = data_utils_train.createNetInputs(double_mel_roll,double_chord_roll, 8)
...
#    model.add(Dropout(0.33))
    ...
    print()
    print("Your Network:")
    model.add(LSTM(input_dim=input_dim, output_dim=num_units[0], activation='tanh', return_sequences=True))
